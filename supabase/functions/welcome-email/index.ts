  ...
  try {
    ...
    const welcomeHtml = `
      ...
      <head>
        ...
        <style>
          ...
          .header { background: linear-gradient(135deg, #D4AF37, #FFD700); padding: 40px; text-align: center; }
      ...
      <body>
        <div class="container">
          ...
          <div class="content">
            ...
            <p>🎁 كوبون خصم 10%: <strong>WELCOME10</strong></p>
          </div>
          <div class="footer">
    ...
    if (RESEND_API_KEY) {
      await fetch('https://api.resend.com/emails', {
        ...
        body: JSON.stringify({
          from: 'Flex Yemen <welcome@flexyemen.com>',
          to: [user.email],
