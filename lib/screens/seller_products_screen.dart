              ...
              if (index == _selectedImages.length) {
                return GestureDetector(
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(color: isDark ? Colors.grey[800] : Colors.grey[200], borderRadius: BorderRadius.circular(12), border: Border.all(color: AppTheme.goldColor, width: 1)),
