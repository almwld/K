...
class _MainNavigationState extends State<MainNavigation> with SingleTickerProviderStateMixin {
  ...
  void initState() {
    super.initState();
    _rotationController = AnimationController(duration: const Duration(milliseconds: 600), vsync: this);
    _rotationAnimation = Tween<double>(begin: 0, end: 2.5).animate(CurvedAnimation(parent: _rotationController, curve: Curves.easeInOut));
  }
  ...
  void _toggleExpand() {
    setState(() {
      ...
      _isExpanded ? _rotationController.forward(from: 0) : _rotationController.reverse();
    });
  }
    ...
    return Scaffold(
      body: Stack(
        children: [
          ...
          if (_isExpanded) GestureDetector(onTap: _toggleExpand, child: Container(color: Colors.black.withOpacity(0.5))),
          if (_isExpanded)
            Positioned(
