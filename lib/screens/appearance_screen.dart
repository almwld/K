        ...
        children: [
          ...
          Container(
            ...
            child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
              ...
              const SizedBox(height: 16),
              RadioListTile<int>(value: 0, groupValue: themeManager.isLightMode ? 0 : (themeManager.isDarkMode ? 1 : 2), onChanged: (value) => themeManager.setThemeModeIndex(0), title: const Text('الوضع النهاري'), subtitle: const Text('ذهبي مع أبيض - مظهر كلاسيكي'), secondary: const Icon(Icons.light_mode, color: AppTheme.goldColor)),
              RadioListTile<int>(value: 1, groupValue: themeManager.isLightMode ? 0 : (themeManager.isDarkMode ? 1 : 2), onChanged: (value) => themeManager.setThemeModeIndex(1), title: const Text('الوضع الداكن'), subtitle: const Text('أسود فحمي مع لمسات ذهبية - فاخر'), secondary: const Icon(Icons.dark_mode, color: AppTheme.goldColor)),
