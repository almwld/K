...
class ThemeSelectionScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Text('اختر المظهر', style: TextStyle(fontWeight: FontWeight.bold)),
        centerTitle: true,
        backgroundColor: isDark ? AppTheme.binanceDark : AppTheme.lightBackground,
      ),
      body: ListView(
        children: [
          _buildOption(
            ...
            isSelected: themeManager.themeMode.name == 'light',
          ...
          _buildOption(
            ...
            isSelected: themeManager.themeMode.name == 'dark',
            onTap: () => themeManager.setDarkMode(),
          ),
          _buildOption(
            context,
            title: 'حسب النظام',
            subtitle: 'مطابقة إعدادات النظام',
            icon: Icons.settings,
            isSelected: themeManager.themeMode.name == 'system',
            onTap: () => themeManager.setThemeMode(ThemeModeOption.system),
          ),
          const Divider(),
          Padding(
