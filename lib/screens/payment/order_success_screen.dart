          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const SizedBox(height: 8),
                Text('إجمالي الطلب: ${totalAmount.toStringAsFixed(2)} ريال', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold, color: AppTheme.gold)),
                ...
                TextButton(onPressed: () {}, child: const Text('تتبع الطلب', style: TextStyle(color: AppTheme.gold))),
              ],
            ),
          ),
        ),
