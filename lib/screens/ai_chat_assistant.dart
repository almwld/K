                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text('${widget.product!.price.toStringAsFixed(0)} ر.ي', style: const TextStyle(color: AppTheme.gold)),
                      ],
                    ),
                  ),
                ],
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                const Spacer(),
                if (!_isTransferring) ...[
                  const Icon(Icons.bolt, size: 16, color: AppTheme.gold),
                        ...
                        child: Column(
                          ...
                          children: [
                            if (isAI)
                              const Row(
                                children: [
                                  Icon(Icons.bolt, size: 12, color: AppTheme.gold),
                                  SizedBox(width: 4),
