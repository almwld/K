...
class InteractiveMapScreen extends StatelessWidget {
  ...
  final List<Map<String, dynamic>> _locations = const [
    {'name': 'صنعاء', 'lat': 15.3694, 'lng': 44.1910, 'type': 'مدينة'},
    {'name': 'عدن', 'lat': 12.7855, 'lng': 45.0187, 'type': 'مدينة'},
    {'name': 'تعز', 'lat': 13.5776, 'lng': 44.0179, 'type': 'مدينة'},
    {'name': 'الحديدة', 'lat': 14.7909, 'lng': 42.9712, 'type': 'مدينة'},
    {'name': 'المكلا', 'lat': 14.5424, 'lng': 49.1278, 'type': 'مدينة'},
  ];
