  ...
  Widget _buildSummary(Map<String, dynamic> fromNetwork, Map<String, dynamic> toNetwork, int amount, int fee, int total) {
    return Container(
      ...
      child: Column(children: [
        ...
        Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [const Text('الإجمالي:', style: TextStyle(fontWeight: FontWeight.bold)), Text('$total ر.ي', style: TextStyle(fontWeight: FontWeight.bold, color: AppTheme.goldColor))]),
      ]),
    );
  }
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(onPressed: () { Navigator.pop(context); _showSuccessDialog(fromNetwork, toNetwork, amount); }, style: ElevatedButton.styleFrom(backgroundColor: AppTheme.goldColor), child: const Text('تأكيد')),
        ],
      ),
    );
  }
