...
class DepositScreen extends StatelessWidget {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        actions: [
          ...
          ElevatedButton(onPressed: () { Navigator.pop(context); _showRequestDialog(context, amountController.text); }, style: ElevatedButton.styleFrom(backgroundColor: AppTheme.goldColor), child: const Text('تقديم طلب')),
        ],
      ),
    );
  }
  ...
  Widget _buildInfoCard(BuildContext context) {
    return Container(
      padding: const EdgeInsets.all(16),
      decoration: BoxDecoration(color: AppTheme.goldColor.withOpacity(0.05), borderRadius: BorderRadius.circular(16), border: Border.all(color: AppTheme.goldColor.withOpacity(0.2))),
      child: Row(children: [
