          ...
          Column(
            ...
            children: [
              Container(
                ...
                child: Image.network(
                  card['image'],
                  errorBuilder: (_, __, ___) => Icon(Icons.card_giftcard, size: 50, color: AppTheme.goldLight),
                ),
              ),
              ...
              Text(
                card['value'],
                style: TextStyle(color: AppTheme.goldLight, fontWeight: FontWeight.bold, fontSize: 14),
              ),
